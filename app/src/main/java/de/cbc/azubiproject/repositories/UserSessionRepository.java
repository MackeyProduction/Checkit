...
public class UserSessionRepository implements IUserSessionRepository {
    ...
    public Collection getAll() {
        return new UserSessionResponse(new HttpRequest(new Endpoint("/sessions")), new ArrayList<UserSession>()).getCollection();
    }

    @Override
    public Collection<UserSession> getByUserId(int id) {
        return new UserSessionResponse(new HttpRequest(new Endpoint("/login")), new ArrayList<UserSession>()).getCollection();
    }
