...
public class UserGroupFromJson {
    public static void main(String[] args)
    {
        ...
        User user = gson.fromJson("{'userId':'1','username':'anheier','password':'$5$11$0hpI86LSfvhS6fTn57B0QJ1xJgHYINArlw.tH5nGcx.','salt':'jZy7VP7bAGup2mgsLBDP','registerDate':'2018-07-29 00:00:00','profile':'null'}", User.class);
